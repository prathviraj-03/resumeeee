    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <div className="flex items-center justify-between p-5 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Select your custom DOCX template</p>
              </div>
            </div>
          ...
          <div className="p-5 space-y-2 max-h-[400px] overflow-y-auto">
            {isLoading ? (
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-muted-foreground/80">No templates found</p>
                <Button
                  variant="link"
              ...
              templates.map((t) => (
                ...
                >
                  <div className={cn(
                    ...
                    selectedId === t.template_id ? "bg-primary-500/20" : "bg-secondary"
                  )}>
                    {selectedId === t.template_id ? (
          ...
          <div className="p-5 border-t border-border bg-secondary/50 flex gap-3">
